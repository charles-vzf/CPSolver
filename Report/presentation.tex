...
\end{frame}
\begin{frame}{N-Reines — nœuds explorés}
  \centering
  \begin{figure}
    \centering
  ...
  \end{figure}
  \note{Présentez cette courbe : comparer configurations (AC vs Forward) et discuter des tendances observées.}
\end{frame}
...
\end{frame}
\begin{frame}{Coloration — visualisation}
  \centering
  \begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{../figures/coloration.png}
    \vspace{2mm}
    \label{fig:coloration_graph}
  \end{figure}
  \note{Expliquez en 20–30s ce que montre la figure : comparaison des configurations, tendances et points saillants.}
\end{frame}
